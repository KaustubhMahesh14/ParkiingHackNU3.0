...
public class activityregis extends AppCompatActivity {
    ...
    Connection con;
    private final String url= "jdbc:mysql://85.10.205.173:3306/parkiing?verifyServerCertificate=false&useSSL=true";
    private final String user="parkiing";
    private final String pass="parkiing";
    public String uname;
